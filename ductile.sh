...
prepare_debian() {
	...
	if (( ! $RECOMMAND )); then
		...
		if (( ! $IS_TEST )); then
			...
			echo "#Generated by ductile@cqumirror
...
deb http://security.debian.org/debian-security bullseye-security main contrib non-free updates
# deb-src http://security.debian.org/debian-security bullseye-security main contrib non-free updates" >> $TMP_DIR/$REPO_FILE;
			else
				echo "# Debian security
# deb http://security.debian.org/debian-security bullseye-security main contrib non-free updates
# deb-src http://security.debian.org/debian-security bullseye-security main contrib non-free updates" >> $TMP_DIR/$REPO_FILE;
...
# deb-src http://mirrors.cqu.edu.cn/debian/ bullseye-updates main contrib non-free" >> $REPO_FILE_DIR/$REPO_FILE
		if (( ! $ONLINE )); then
			echo "# Debian security
deb http://security.debian.org/debian-security bullseye-security main contrib non-free updates
# deb-src http://security.debian.org/debian-security bullseye-security main contrib non-free updates" >> $REPO_FILE_DIR/$REPO_FILE;
		else
			echo "# Debian security
# deb http://security.debian.org/debian-security bullseye-security main contrib non-free updates
# deb-src http://security.debian.org/debian-security bullseye-security main contrib non-free updates" >> $REPO_FILE_DIR/$REPO_FILE;
